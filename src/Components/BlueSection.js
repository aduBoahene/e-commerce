    ...
    <div className='bg-[#0e2165]'>
        <div className='w-1/2 mx-auto p-4 md:w-5/6 md:mx-auto md:p-16 md:flex md:gap-6'>
            <OneItem 
              ...
              title={`Free Shipping`} 
              description={`Pron Condimentus sagtties`}/>
...
function OneItem({image, title, description}){
    return(
        <div className='text-center mb-4 text-white md:flex md:text-white md:font-[Poppins]'>
